...
<table class="form-table">
    <tbody>
        ...
        <tr>
            <th scope="row"><label for="product-price-sales"><?php echo __('Giá khuyến mãi:', 'ducanh-shop') ?></label></th>
            <td><input name="product-price-sales" type="text" value="<?php echo $product_price_sales; ?>" class="regular-text"></td>
        </tr>
        <tr>
            <th scope="row"><label for="product-stock"><?php echo __('Số lượng:', 'ducanh-shop') ?></label></th>
